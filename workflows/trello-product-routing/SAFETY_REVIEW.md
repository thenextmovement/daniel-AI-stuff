...
- P1: Alte kombinierte Dropdownwerte dürfen nicht gelöscht werden, bevor bestehende Karten atomar auf `LED Neon` migriert und rückgelesen wurden.
- P1: Full Glow und Ultra Thin dürfen weder auf den Neon-Dropdownwert noch auf die Neon-Preisleiter fallen.
...
| --- | ---: | --- |
| correctness | 5 | Sieben getrennte Werte, unbekannte Werte bleiben leer, Product 2 bleibt manuell. |
