...
- `[im Repository verifiziert; Produktion offen]` Der Completed-Offers-Sync liefert beim erstmaligen Verknüpfen einer nachweislich unplausiblen historischen Shopify-Order einen datenschutzarmen internen Watchdog-Alarm. Er meldet nur und repariert den Sale nicht automatisch.
