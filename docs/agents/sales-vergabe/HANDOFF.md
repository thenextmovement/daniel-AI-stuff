...
- `[im Repository verifiziert; Produktion offen]` Der Completed-Offers-Sync blockiert eine nachweislich unplausible historische Shopify-Order vor dem Merge, speichert einen datenschutzarmen Guard-Marker und liefert den internen Watchdog-Alarm pro Kandidat genau einmal. Der Sale bleibt unverknüpft und seine Angebotsdaten bleiben erhalten.
