...
drop function if exists public.seventeen_track_daily_registration_capacity(integer, timestamptz);
drop function if exists public.seventeen_track_daily_registration_count(timestamptz);
