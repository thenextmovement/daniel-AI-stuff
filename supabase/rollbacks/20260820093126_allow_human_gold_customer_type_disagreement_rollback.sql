-- NEONTRIP rollback: restore the Phase-2 human-Gold customer_type veto.
-- This changes only the adjudication function. It never deletes or mutates
-- existing immutable Gold, classifications, jobs, master segments or requests.
