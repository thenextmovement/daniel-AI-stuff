...
begin
  ...
  where n.nspname = 'public'
    and p.proname = 'ro_enqueue_first_party_trello_projection_v1'
    and p.prokind = 'f';

  if current_definition is null then
    raise exception 'Expected RIESENOBJEKTE Trello projection trigger function is missing';
  end if;

  if md5(current_definition) <> '184eafb758567226d58148b219b96181' then
    raise exception 'RIESENOBJEKTE Trello projection trigger changed since preflight';
  end if;
end;
$guard$;
