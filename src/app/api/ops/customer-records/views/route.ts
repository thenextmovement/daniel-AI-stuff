...
import { recordCustomerCardView } from "@/lib/ops/customer-records";
...
function failureResponse(error: unknown) {
  ...
  console.error("ops customer-records views route failed", error);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const result = await recordCustomerCardView({
