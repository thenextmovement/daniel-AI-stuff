...
import {
  type CustomerTrelloFieldUpdateInput,
  type UpdateActor,
  updateCustomerTrelloFields,
...
function failureResponse(error: unknown) {
  ...
  console.error("ops customer-records trello-fields route failed", error);
...
export async function PATCH(request: NextRequest) {
  ...
  try {
    ...
    const result = await updateCustomerTrelloFields(
      String(body.requestId || ""),
      String(body.boardKey || ""),
      body.updates || [],
      actor,
    );
