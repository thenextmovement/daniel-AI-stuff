          ...
          <div className="hidden bg-stone-950 p-10 text-white lg:flex lg:flex-col lg:justify-between">
            <div>
              ...
              <p className="mt-5 max-w-sm text-sm leading-7 text-stone-300">
                Kundenakte, Company Brain, Anrufe, Aufgaben, Angebote, Produktion, Versand und Wareneingang bleiben geschützt. Änderungen werden serverseitig geprüft und protokolliert.
              </p>
            </div>
