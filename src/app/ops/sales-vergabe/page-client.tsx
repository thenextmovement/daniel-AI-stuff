...
function SaleCard({
  ...
  return (
    <article className={`rounded-[0.5rem] border bg-white p-4 shadow-sm ${paidPriority ? "border-emerald-300 ring-2 ring-emerald-100" : priorPaidPriority ? "border-blue-400 ring-2 ring-blue-100" : "border-stone-200"}`}>
      <div className="grid gap-4 lg:grid-cols-[7rem_minmax(0,1fr)_minmax(20rem,0.78fr)]">
        ...
        <div className="min-w-0">
          ...
          {priorPaidPriority ? (
            <div className="mb-3 flex flex-wrap items-center gap-2 rounded-[0.5rem] border border-blue-400 bg-blue-50 px-3 py-2 text-sm font-semibold text-blue-950">
              <BadgeCheck className="h-4 w-4 text-blue-700" />
              Jetzt unbezahlt · frueher bereits bezahlt
              ...
              {sale.priorPaidCustomer.lastPaidOrderUrl ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1 rounded-[0.5rem] border border-blue-400 bg-white px-2.5 py-1 text-xs font-semibold text-blue-950 hover:border-blue-700"
                >
                  Shopify-Beleg
                  <ExternalLink className="h-3.5 w-3.5" />
                </a>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {priorPaidPriority ? (
              <span className="inline-flex items-center gap-1 rounded-full border border-blue-400 bg-blue-50 px-2.5 py-1 text-[11px] font-semibold text-blue-950">
            ...
            {supplier === "quentin" ? (
              <div className="grid gap-3 rounded-[0.5rem] border border-stone-200 bg-stone-50 p-3">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <div>
                    <p className="text-sm font-semibold text-stone-950">Quentin-Trello-Karte</p>
                    <p className="text-xs leading-5 text-stone-600">Karte zuordnen und das freigegebene Design kontrolliert hochladen.</p>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      type="button"
                      disabled={saving || trelloDescriptionBusy}
                      title="Exakte Karte auf dem Quentin-Board suchen und Approved Design pruefen"
                ...
                {trelloLinkSaved ? (
                  <p className="flex items-center gap-2 rounded-[0.5rem] border border-emerald-200 bg-emerald-50 px-3 py-2 text-xs font-medium text-emerald-900">
                    <CheckCircle2 className="h-4 w-4" />
                    Quentin-Karte geprueft, neu zugeordnet und Kartendetails geladen.
                  </p>
                ) : null}
                ...
                {trelloDescription ? (
                  <div className="grid gap-3">
                    ...
                    <p className="text-[11px] text-stone-500">Kartendetails zuletzt direkt aus Trello geladen: {formatDateTime(trelloDescription.fetchedAt)}</p>
                  </div>
                ) : null}
              </div>
            ) : null}
