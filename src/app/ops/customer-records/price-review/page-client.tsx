...
export function SupplierPriceReviewClient({
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#fffdf9] px-4 py-5 text-black md:px-6 lg:px-8">
      <div className="mx-auto flex w-full min-w-0 max-w-[1180px] flex-col gap-5">
        <header className="rounded-[28px] border border-white/10 bg-[linear-gradient(135deg,#050505_0%,#111111_58%,#18181b_100%)] px-5 py-4 text-white shadow-[0_24px_80px_rgba(0,0,0,0.22)]">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex w-full min-w-0 flex-wrap items-center gap-2 sm:w-auto sm:justify-end">
              <OpsModuleNav active="price-review" variant="dark" />
              <button
                type="button"
