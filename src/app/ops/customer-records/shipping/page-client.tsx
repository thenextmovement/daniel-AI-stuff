...
export function CustomerShippingClient({
  ...
  if (!hasSession && !localMode) {
    return (
      <main className="min-h-screen overflow-x-hidden bg-stone-100 p-6 text-stone-900">
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-stone-100 px-4 py-6 text-stone-900 md:px-8">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
        <header className="rounded-[0.5rem] bg-stone-950 px-6 py-6 text-white">
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <OpsModuleNav active="shipping" variant="dark" />
          </div>
        </header>
          ...
          <div className="grid gap-3 md:grid-cols-[1fr_180px_180px_160px]">
            <label className="relative">
              ...
              <input
	            ...
	            <select value={scope} onChange={(event) => setScope(event.target.value as typeof scope)} className="rounded-[0.5rem] border border-stone-300 px-3 py-2 text-sm" aria-label="Shipping-Ansicht">
	            ...
	            <select value={carrier} onChange={(event) => setCarrier(event.target.value as typeof carrier)} className="rounded-[0.5rem] border border-stone-300 px-3 py-2 text-sm" aria-label="Carrier filtern">
